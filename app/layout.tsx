...
export const metadata: Metadata = {
	title: "RoastIn",
	description: "Hot Chillies in your <textarea>",
	metadataBase: new URL("https://roast-in.vercel.app"),
	twitter: {
		...
		<html lang="en">
			...
			>
				...
				<footer className="text-center text-sm dark:text-gray-400 text-gray-600 font-mono">
					<p>
						<A href="https://github.com/madhaviit">madhaviit</A> /{" "}
						<A href="https://magic-spell.vercel.app/">reference</A>
					</p>
					<p>
						Built with{" "}
